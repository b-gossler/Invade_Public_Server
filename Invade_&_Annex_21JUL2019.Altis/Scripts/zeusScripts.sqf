...
ZeusSpam = 		parseText "<t align='center' font='PuristaBold' ><t size='1.4' color='#ff0000'>WARNING to ALL</t><t size='0.9'><br />Do not spam the zeus key (Y)<br /> This could result in action being taken against you.</t></t>";ZeusActive = 	parseText "<t align='center' font='PuristaBold' ><t size='1.2'>Message from zeus</t><t size='0.8'><br />Zeus is now active, AI is no longer dumb.<br />They now see tracers, IR lasers, hear gunshots, ...</t></t>";
...
artyExclusionScript = {
	...
	if (numberOfArtyExlusions > 5) then {
		...
		artyNoFiringLocations = artyNoFiringLocations - [artyNoFiringLocations # 0];
...
MMIA = [  
	...
	["Arty exclusion zones",   			[5], "#USER:MMExclu",  -5, [["expression", ""]], "1", ""],
	["Create limited arsenal",  		[6], "", -5, [["expression", "[] spawn createArsenal;" ]],"", ""],
...
MMAdmin = [  
	...
	["Add all objects to zeus",  [5], "", -5, [["expression", "[['INeedToTypeSomethingHere'], zeusUpdaterFnc] remoteExec ['spawn', 2];"]],"", ""],
	["Remove weapons from player",[7], "", -5, [["expression", "[] spawn removeWeaponScript;"]],"", ""],
    ["Back",      		         [6], "", -4, [["expression", ""]], "1", ""]
]; 
