...
kickPlayerWithReason = { 
	...
	[[_adminMessage], logFnc] remoteExec ["spawn", 2];
	[Quartermaster, [adminChannelID, _adminMessage]] remoteExecCall ["customChat", 0];
	titleText ["<t align='center'><t size='1.8' font='PuristaBold'>Your use of scripts has been detected.<br /> You will be kicked shortly.</t><br /> <t size='1.2' font='PuristaBold'>Your unique ID has been logged along with with your name.</t><br/><br /><t size='1.0' font='PuristaBold'>This message will not go away.</t><br/><br/><t size='0.8' font='PuristaBold'>Your user account will likely be banned for the use of these scripts. Appeal any bans on our website (69thid.com)</t></t>", "BLACK", 2, true, true];
...
banPlayerWithReason = { 
	...
	[[_adminMessage], logFnc] remoteExec ["spawn", 2];
	[Quartermaster, [adminChannelID, _adminMessage]] remoteExecCall ["customChat", 0];
	titleText ["<t align='center'><t size='1.8' font='PuristaBold'>Your use of scripts has been detected.<br /> All user input has been disabled.</t><br /> <t size='1.2' font='PuristaBold'>Your unique ID has been logged along with with your name.</t><br/><br /><t size='1.0' font='PuristaBold'>This message will not go away and your input will not be re-enabled.</t><br/><br/><t size='0.8' font='PuristaBold'>Your user account will likely be banned for the use of these scripts. Appeal any bans on our website (69thid.com)</t></t>", "BLACK", 2, true, true];
