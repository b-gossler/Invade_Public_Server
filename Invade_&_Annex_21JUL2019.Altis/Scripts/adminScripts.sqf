...
MMHints = [  
	...
	["Server UpTime", 			[9], "",  -5, [["expression", "uptime = round(serverTime/60/60); GHINT   = { hint format ['Server up for %1 hours',uptime];};publicVariable 'GHINT';remoteExecCall ['GHINT'];"]],"", ""],
...
MMIA = [  
	...
	["Arty exclusion zones",   	[6], "#USER:MMExclu",  -5, [["expression", ""]], "1", ""],
	["spawn reward",			[7], "#USER:MMRewards", -5, [["expression", ""]], "1", ""], 
	["Create limited arsenal",  [8], "", -5, [["expression", "[] spawn createArsenal;" ]],"", ""],
	["Other",   				[9], "#USER:MMIAOther",  -5, [["expression", ""]], "1", ""],
...
MMIAOther = [
	...
	["Print kicklog to your RPT",[8], "", -5, [["expression", "[clientOwner, 'kickedPlayerList'] remoteExec ['publicVariableClient']; diag_log 'Print out of the people kicked/banned for hacking today: '; {diag_log str _x} forEach kickedPlayerList; hint 'The kicklog has been printed in your RPT which can by default be found at C:\Users\yourUser\AppData\Local\Arma 3';"]], "1", ""],
...
MMAdmin = [  
	...
	["Add all objects to zeus",  [7], "", -5, [["expression", "[['INeedToTypeSomethingHere'], zeusUpdaterFnc] remoteExec ['spawn', 2];"]],"", ""],
	["Remove weapons from player",[8], "", -5, [["expression", "[] spawn removeWeaponScript;"]],"", ""],
	["Back",      		         [9], "", -4, [["expression", ""]], "1", ""]
]; 
...
MYOWN = [  
	...
	["Force down player", [5], "",  -5, [["expression", "BADBOY = cursorTarget; if (BADBOY isKindOf 'Man') then {['down', BADBOY] spawn reviveOrDownPlayer;} else {hint 'no player found';};"]],"", ""],
	["Revive player",     [6], "",  -5, [["expression", "BADBOY = cursorTarget; if (BADBOY isKindOf 'Man') then {['revive', BADBOY] spawn reviveOrDownPlayer;} else {hint 'no player found';};"]],"", ""]
];
