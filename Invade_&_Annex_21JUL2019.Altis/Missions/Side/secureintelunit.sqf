...
//-------------------------------------------------------------------------- CREATE GROUP, VEHICLE AND UNIT
	...
	private _intelObj = _aGroup createUnit [(selectRandom _objUnitTypes), _flatPos1, [], 0, "NONE"];
	...
	private _decoy1 = _bGroup createUnit [(selectRandom _objUnitTypes), _flatPos1, [], 0, "NONE"];
	...
	private _decoy2 = _cGroup createUnit [(selectRandom _objUnitTypes), _flatPos1, [], 0, "NONE"];
