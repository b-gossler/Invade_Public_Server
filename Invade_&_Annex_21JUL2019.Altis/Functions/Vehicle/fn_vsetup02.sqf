...
switch (_vehicleType) do {
    case "B_Plane_CAS_01_dynamicLoadout_F": { //wipeout
    	...
    	{_vehicle removeWeapon _x} forEach ["Missile_AGM_02_Plane_CAS_01_F"];
    	...
    	//==========missiles==========
    	_vehicle setPylonLoadOut [3, "PylonRack_3Rnd_LG_scalpel",false,[]];
    	_vehicle setPylonLoadOut [8, "PylonRack_3Rnd_LG_scalpel",false,[]];
    };
    ...
    case "B_Heli_Attack_01_F": { // Comanche
	
		{_vehicle removeWeapon _x} forEach ["missiles_DAGR", "missiles_ASRAAM"];
        //_vehicle removeWeapon "missiles_DAGR";
		
		_vehicle setPylonLoadOut [1, "PylonMissile_1Rnd_LG_scalpel", true, [0]];
    	_vehicle setPylonLoadOut [2, "PylonMissile_1Rnd_LG_scalpel", true, [0]];
    	_vehicle setPylonLoadOut [3, "PylonMissile_1Rnd_LG_scalpel", true, [0]];
    	_vehicle setPylonLoadOut [4, "PylonMissile_1Rnd_LG_scalpel", true, [0]];
		_vehicle setPylonLoadOut [5, "PylonMissile_1Rnd_LG_scalpel", true, [0]];
    	_vehicle setPylonLoadOut [6, "PylonMissile_1Rnd_LG_scalpel", true, [0]];
		
	};
	
	case "B_Heli_Attack_01_dynamicLoadout_F": { // Comanche
	
		{_vehicle removeWeapon _x} forEach ["missiles_DAGR", "missiles_ASRAAM"];
        //_vehicle removeWeapon "missiles_DAGR"; -> Note -> PylonMissile_1Rnd_AAA_missiles
	...
	//case "B_UAV_02_dynamicLoadout_F": { // Uav -> Not Working
	//
	//	{_vehicle removeWeapon _x} forEach ["missiles_SCALPEL"];
    //    //_vehicle removeWeapon "missiles_DAGR";
	//	
	//	_vehicle setPylonLoadOut [1, "PylonRack_Bomb_GBU12_x1", false, [0]];
    //	_vehicle setPylonLoadOut [2, "PylonRack_3Rnd_LG_scalpel", false, [0]];
    //
	//};
	
	//case "B_UAV_02_F": { // Uav -> Not Working
	//
	//	{_vehicle removeWeapon _x} forEach ["missiles_SCALPEL"];
    //   //_vehicle removeWeapon "missiles_DAGR";
	//	
	//	_vehicle setPylonLoadOut [1, "PylonRack_3Rnd_LG_scalpel", false, [0]];
    //	_vehicle setPylonLoadOut [2, "PylonRack_Bomb_GBU12_x1", false, [0]];
	//	
	//};
	
	//case "B_UAV_02_CAS_F": { // Uav -> Not Working
	//
	//	{_vehicle removeWeapon _x} forEach ["missiles_SCALPEL"];
    //    //_vehicle removeWeapon "missiles_DAGR";
	//	
